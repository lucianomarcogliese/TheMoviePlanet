...
var article = ""
  fetch (url)
    ...
    for (i = 0; i < arrayDeGeneros.length; i++) {
      arrayDeGeneros[i]
      article += "<li> <a href= '/peliculas/PorGenero?idGenero=" + arrayDeGeneros[i].id + "'>" + arrayDeGeneros[i].name + "</a> </li>"
    }
...
document.querySelector(".peliculasRecomendadas").innerHTML+= '<li><a href="peliculas/detalle?idDePelicula='+recomendaciones[i].id +
